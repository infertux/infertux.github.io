...
Unfortunately, Bash doesn't have such niceties but we can use the [xtrace feature](https://www.gnu.org/software/bash/manual/bash.html#index-BASH_005fXTRACEFD) which prints every line executed using [PS4](https://www.gnu.org/software/bash/manual/bash.html#index-PS4).
